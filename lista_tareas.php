...
if (isset($_SESSION["categoria"])) {
    ...
    $statementconsulta = $conexion->query("SELECT titulo, descripcion, fecha_creacion, fecha_actividad, duracion, estado FROM tarea INNER JOIN categoria on tarea.id_categoria = categoria.id WHERE nombre_categoria = '$nombre_categoria'");
